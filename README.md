...
This repository is based on the unofficial implementation of ZipLoRA, [ziplora-pytorch](https://github.com/mkshing/ziplora-pytorch) by [mkshing](https://twitter.com/mk1stats). It adds the missing ablation study on the soft orthogonality regularization term that was not included in the original ZipLoRA paper ([https://ziplora.github.io](https://ziplora.github.io)).
